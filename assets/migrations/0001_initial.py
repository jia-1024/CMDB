    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('myadmin', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='myadmin', to=settings.AUTH_USER_MODEL, verbose_name='资产管理员')),
